    ...
    <div className="about-page">
      ...
      <div className="about-section">
        <div className="about-story">
          <h2>Who We Are</h2>
          <p>
            FreshMart started in 2021 in Coimbatore, Tamil Nadu, with a small team of farmers, foodies, and technologists
            who were tired of stale produce and middlemen. We set out to eliminate the gap between farm and kitchen.
          </p>
          <p>
            Today, we partner with over 200 farms across South India, delivering 10,000+ orders every week to households
            who care about what's on their plate.
          </p>
        </div>
        <div className="about-image-box">
          <img src="https://images.unsplash.com/photo-1542838132-92c53300491e?w=600&auto=format&fit=crop" alt="Farm" />
        </div>
      </div>
      ...
      <div className="about-team">
        ...
        <div className="team-grid">
          {[
            { name: "Arun Selvam",    role: "Founder & CEO",       emoji: "👨‍💼" },
            { name: "Meera Krishnan", role: "Head of Operations",   emoji: "👩‍💼" },
            { name: "Vijay Raj",      role: "Farm Relations Lead",  emoji: "👨‍🌾" },
            { name: "Priya Nair",     role: "Customer Experience",  emoji: "👩‍💻" },
          ].map(t => (
