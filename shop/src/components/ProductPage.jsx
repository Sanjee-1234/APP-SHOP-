...
const REVIEWS = [
  { name: "Priya S.",   rating: 5, comment: "Absolutely fresh! Delivered within 3 hours. Will buy again.", date: "2 days ago" },
  { name: "Rahul M.",   rating: 4, comment: "Great quality, neat packaging and product was in perfect condition.", date: "1 week ago" },
  { name: "Ananya K.",  rating: 5, comment: "Best grocery delivery app. Fresh produce and reasonable prices.", date: "2 weeks ago" },
  { name: "Karthik R.", rating: 4, comment: "Good product. Slightly smaller than expected but taste is excellent.", date: "3 weeks ago" },
];
    ...
    <div className="product-page">
      ...
      <div className="product-layout">
        <div className="product-image-box">
          ...
          <button className={`product-wishlist-btn${wishlisted ? " active" : ""}`} onClick={() => toggleWishlist(product)}>
        ...
        <div className="product-info">
          ...
          <div className="product-features">
            {[["✓","Quality-checked & fresh daily"],["🚚","Same-day delivery available"],["🔄","Easy 24h return policy"],["🌿","Sourced from trusted farmers"]].map(([icon, text]) => (
